...
A web app to help you meet people
...
meet-me relies extensively on environment settings which **will not work with Apache/mod_wsgi setups**. It has been deployed successfully with both Gunicorn/Nginx and even uWSGI/Nginx.

For configuration purposes, the following table maps the 'meet-me' environment variables to their Django setting:
...
DJANGO_DEFAULT_FROM_EMAIL               DEFAULT_FROM_EMAIL          n/a                                            "meet-me <noreply@example.com>"
DJANGO_SERVER_EMAIL                     SERVER_EMAIL                n/a                                            "meet-me <noreply@example.com>"
DJANGO_EMAIL_SUBJECT_PREFIX             EMAIL_SUBJECT_PREFIX        n/a                                            "[meet-me] "
======================================= =========================== ============================================== ======================================================================
...
To run the tests, enter the meet-me/tests directory and run the following commands::
...
Postgres is saving its database files to `/data/meet-me/postgres` by default. Change that if you wan't
...
Place it in `/etc/supervisor/conf.d/meet-me.conf` and run::

    supervisorctl reread
    supervisorctl start meet-me
